...
class Task(models.Model):
    ...
    reporter = models.ForeignKey(User, related_name='reported_tasks', null = True, on_delete=models.CASCADE)
    assignee = models.ForeignKey(User, related_name='assigned_tasks', null = True, on_delete=models.CASCADE)
